      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-gray-500 text-sm mb-4">
              The ultimate TradingView indicator for crypto traders. Trade with
              precision and confidence.
            </p>
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-lg bg-card-border flex items-center justify-center text-gray-400 hover:text-foreground transition-colors"
              >
        ...
        <div className="pt-8 border-t border-card-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            © 2025 TouchGrass. All rights reserved.
          </p>
